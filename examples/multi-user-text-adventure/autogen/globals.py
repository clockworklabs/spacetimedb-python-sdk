...
class Globals:
    ...
    @classmethod
    def filter_by_spawnable_entity_id_counter(
        cls, spawnable_entity_id_counter
    ) -> List[Globals]:
        return [
            column_value
            for column_value in SpacetimeDBClient.instance._get_table_cache(
            ...
            if column_value.spawnable_entity_id_counter == spawnable_entity_id_counter
        ]
